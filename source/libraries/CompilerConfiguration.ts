...
export class CompilerConfiguration {
    ...
    public static create(): CompilerConfiguration {
        ...
        const activeContracts = ["sai/fab.sol", "sai/mom.sol", "sai/pit.sol", "sai/tap.sol", "sai/top.sol", "sai/tub.sol", "sai/vox.sol", "sai/weth9.sol", "ds-token/token.sol", "ds-value/value.sol", "ds-roles/roles.sol", "maker-otc/matching_market.sol"];
